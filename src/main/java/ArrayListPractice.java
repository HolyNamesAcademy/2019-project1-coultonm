...
public class ArrayListPractice {
    ...
    /*
    Returns the student whose favorite color is the one passed in.
     */
    ...
    /*
    Returns the favorite color of the person with the name that is passed in.
     */
    ...
    /*
    Transfer money from Student 1 to Student 2.
